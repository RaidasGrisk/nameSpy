...
docker push gcr.io/namesapi-1581010760883/amespy-api
gcloud run deploy --image gcr.io/namesapi-1581010760883/amespy-api --platform managed --region europe-north1
