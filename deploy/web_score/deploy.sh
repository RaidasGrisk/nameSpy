...
docker build -f deploy/web_score/Dockerfile . --tag gcr.io/namesapi-1581010760883/socialscore
...
gcloud run services update socialscore --memory 2G --platform managed --region europe-north1 --max-instances 5
